...
import { formatDateTime, formatShiftWindow } from '../utils/format';
      ...
      <View style={styles.panelStrong}>
        <View style={styles.shiftHeader}>
          <View style={styles.shiftCopy}>
            <Text style={styles.panelKicker}>Today's duty</Text>
      ...
      <View style={styles.panel}>
        ...
        <View style={styles.list}>
          {recentLogs.length ? recentLogs.map((log) => (
            ...
            <EmptyState
              title="No visitor movement yet"
              detail="New arrivals, approvals, and check-outs will show up here."
            />
          )}
        </View>
      </View>
