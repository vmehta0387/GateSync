    ...
    <SafeAreaView edges={['top', 'left', 'right', 'bottom']} style={styles.safeArea}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.screen}>
        <View style={styles.hero}>
          <Text style={styles.brand}>GateSync</Text>
          <Text style={styles.title}>Mobile App</Text>
          <Text style={styles.subtitle}>
            Residents manage society operations, and guards handle gate activity from the same GateSync app.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardSubtitle}>
            Use the mobile number already linked to your GateSync resident or guard profile.
          </Text>
